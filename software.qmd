...
The complete block diagram can be found below (@fig-block):

![Complete Block Diagram for FPGA. Note all wires with the sane name are connected (e.g. int_osc and reset are shared across all modules)](images/CompleteBlockDiagram.jpg){#fig-block}
