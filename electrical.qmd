...
The MCU uses a Capacitive Touch Sensor to detect a user's hand to trigger the start of the whole sequence. The GPIO receives that signal on PA8 which simulata neously triggeres PA5 which is electrically connected to P47 to send a signal to the FPGA components as well.
...
The circuit itself is largely inspired by sample circuits on the [Picaxe Datasheet](https://picaxe.com/docs/spe033.pdf) that we later found as well as a [MP3-TF-16p Tutorial on Youtube](https://www.youtube.com/watch?v=7WiSeQxb1bU). 
